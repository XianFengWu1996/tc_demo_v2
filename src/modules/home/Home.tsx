...
import { HomeButtonGroup, HomeContainedButton, HomeOutlinedButton, HomeSection, HomeTitle } from "./styles/styles"
...
export const HomePage = () => {
    ...
    return <HomeSection>
        <Image src={Logo.src} alt="taipei logo" height={120} width={140} />
            ...
            <HomeButtonGroup>
                <HomeContainedButton variant="contained" size="large" onClick={handleContainedButtonOnClick}>Order</HomeContainedButton>
                <HomeOutlinedButton variant="outlined" size="large" onClick={handleOutlinedButtonOnClick}>Explore Menu</HomeOutlinedButton>
            </HomeButtonGroup>
        </div>

import { Box, Button, Checkbox, Divider, FormControlLabel, Grid, InputBase, Typography } from "@mui/material";
        ...
        <Grid item lg={6} height={'calc(100vh - 63px)'} sx={{ bgcolor:'red'}}>
            ...
            <Grid item lg={6} >
               <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mt: 10}}>
                    ...
                    <Divider sx={{ my:1, width: '90%', fontSize: 13, color: 'rgba(0, 0, 0, 0.40)'}}>or signup with email</Divider>
                    ...
                    <Box sx={{ display: 'flex', flexDirection: 'column', width: '425px'}}>
                        ...
                        <Typography sx={{ fontSize: 14, fontWeight: 600}}>Confirm Password</Typography>
                        <InputBase
                        ...
                        />
                        <Button variant="contained" sx={{ my: 2}}>Sign Up</Button>
                        
                        <Link href={'/auth/signin'}>
                            <Typography sx={{ mb: 3, fontSize: 14, cursor: 'pointer'}}>Already have an account?</Typography>
                        </Link>

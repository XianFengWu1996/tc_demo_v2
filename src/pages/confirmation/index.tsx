    ...
    return <>
        ...
        <Box sx={{ px: 20, py: 5}}>
            ...
            <Box sx={{ my: 2}}>
                ...
                <Typography>Thank you for placing order with us today. The order summary are shown below, if you have any question please contact us at example_email@gmail.com</Typography>
            </Box>
                ...
                <Card sx={{ my: 2}} elevation={0}>
                    <CardContent>
                        <Box sx={{ display: 'flex', justifyContent: 'space-between'}}>
                            <Box sx={{ display: 'flex'}}>
                                <Image src={FallBackImage.src} height={60} width={60} alt={'Image of food'} />

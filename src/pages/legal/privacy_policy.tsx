      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device, named Taipei
            Cuisine
          </p>
        </li>
        <li>
          <p>
            ...
            this Agreement) refers to Taipei Cuisine Inc, 68 Billings Road,
            Quincy, MA, 02171.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Taipei Cuisine, accessible from{' '}
            <a
              href="https://taipeicuisines.com"
              rel="external nofollow noopener noreferrer"
              target="_blank"
            >
              https://taipeicuisines.com
            </a>
          </p>
        </li>
        <li>

  ...
  return (
    <div>
      ...
      <p>
        ...
        of TAIPEI CUISINE INC's Website, located at https://taipeicuisines.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use TAIPEI CUISINE if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing TAIPEI CUISINE, you agreed to
        use cookies in agreement with the TAIPEI CUISINE INC's Privacy Policy.{' '}
      </p>
      ...
      <p>
        Unless otherwise stated, TAIPEI CUISINE INC and/or its licensors own the
        intellectual property rights for all material on TAIPEI CUISINE. All
        intellectual property rights are reserved. You may access this from
        TAIPEI CUISINE for your own personal use subjected to restrictions set
      ...
      <p>
        ...
        TAIPEI CUISINE INC does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the
        views and opinions of TAIPEI CUISINE INC,its agents and/or affiliates.
        Comments reflect the views and opinions of the person who post their
        views and opinions. To the extent permitted by applicable laws, TAIPEI
        CUISINE INC shall not be liable for the Comments or for any liability,
      ...
      <p>
        TAIPEI CUISINE INC reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant TAIPEI CUISINE INC a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of TAIPEI CUISINE INC; and (d) the
      ...
      <p>
        ...
        e-mail to TAIPEI CUISINE INC. Please include your name, your
      ...
      <p>
        No use of TAIPEI CUISINE INC's logo or other artwork will be allowed for
